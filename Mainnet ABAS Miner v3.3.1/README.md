...
2c) MinABASperMint=
  - If omitted, it is set to the default 3.5 ABAS Tokens per mint transaction.
  - Replace this value with the amount of ABAS Tokens you wish to recieve per Mint.
...
7) Save and run 'ABAS Miner Start.bat file' in this directory.
...
Thanks for trying out this miner!
 ...
 Suggested a new account with minimial Arbitrum Ethereum to begin (10-30$).
...
Note that there is a configuration file "ABAS_Miner.Conf" that saves previous CLI parameters/settings, delete it prior to changing CLI parameters.
...
You will have to supply your own Arbitrum address (or Private key if you solo mine). It is your own responsibility to mine to the correct address/account.
